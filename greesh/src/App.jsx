...
//             Required columns: Date · Region · Product · Revenue · Cost · Marketing
//           </p>
//         </>
//       )}
//     </div>
...
//             <h1 className="hero-title">Business<br/>Analytics</h1>
//             <p className="hero-sub">Upload a CSV and get instant insights — revenue, profit, trends.</p>
